...
;
COMMENT ON COLUMN "public"."emergency_task"."task_id" IS '主键ID';
COMMENT ON COLUMN "public"."emergency_task"."task_no" IS '任务编号';
COMMENT ON COLUMN "public"."emergency_task"."task_name" IS '任务名称';
COMMENT ON COLUMN "public"."emergency_task"."task_type" IS '任务类型 1自定义压测 2 引流压测 3命令行';
COMMENT ON COLUMN "public"."emergency_task"."scene_id" IS '场景ID';
COMMENT ON COLUMN "public"."emergency_task"."script_id" IS '脚本ID';
COMMENT ON COLUMN "public"."emergency_task"."server_id" IS '服务器ID集合';
COMMENT ON COLUMN "public"."emergency_task"."pre_task_id" IS '所依赖的任务ID';
COMMENT ON COLUMN "public"."emergency_task"."create_user" IS '创建人';
COMMENT ON COLUMN "public"."emergency_task"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."emergency_task"."is_valid" IS '是否生效';
COMMENT ON COLUMN "public"."emergency_task"."channel_type" IS '通道类型';
COMMENT ON COLUMN "public"."emergency_task"."script_name" IS '脚本名称';
COMMENT ON COLUMN "public"."emergency_task"."submit_info" IS '提交信息';
COMMENT ON COLUMN "public"."emergency_task"."perf_test_id" IS '压测场景ID';
...
-- ----------------------------
ALTER TABLE "public"."emergency_task" ADD CONSTRAINT "emergency_task_pkey" PRIMARY KEY ("task_id");
