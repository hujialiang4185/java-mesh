...
;
COMMENT ON COLUMN "public"."emergency_group"."group_name" IS '组名';
COMMENT ON COLUMN "public"."emergency_group"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."emergency_group"."create_user" IS '创建人';
...
-- ----------------------------
ALTER TABLE "public"."emergency_group" ADD CONSTRAINT "emergency_group_pkey" PRIMARY KEY ("group_id");
