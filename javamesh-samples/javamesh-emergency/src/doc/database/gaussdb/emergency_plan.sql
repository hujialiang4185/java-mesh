...
;
COMMENT ON COLUMN "public"."emergency_plan"."plan_id" IS '主键ID';
COMMENT ON COLUMN "public"."emergency_plan"."plan_no" IS '预案编号';
COMMENT ON COLUMN "public"."emergency_plan"."plan_name" IS '预案名称';
COMMENT ON COLUMN "public"."emergency_plan"."plan_group" IS '分组';
COMMENT ON COLUMN "public"."emergency_plan"."create_user" IS '创建人';
COMMENT ON COLUMN "public"."emergency_plan"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."emergency_plan"."is_valid" IS '是否生效';
COMMENT ON COLUMN "public"."emergency_plan"."check_user" IS '审核人';
COMMENT ON COLUMN "public"."emergency_plan"."check_time" IS '审核时间';
COMMENT ON COLUMN "public"."emergency_plan"."check_remark" IS '审核意见';
COMMENT ON COLUMN "public"."emergency_plan"."status" IS '状态位 0 新增 1 待审核 2 已审核 3拒绝 4 运行中 5 运行成功 6 运行失败';
COMMENT ON COLUMN "public"."emergency_plan"."schedule_type" IS '调度类型 0 仅触发一次 1 固定间隔 2 cron表达式';
COMMENT ON COLUMN "public"."emergency_plan"."schedule_conf" IS '调度配置（cron表达式 固定间隔 时间点）';
COMMENT ON COLUMN "public"."emergency_plan"."schedule_status" IS '调度状态 0停止调度 1开始调度';
COMMENT ON COLUMN "public"."emergency_plan"."trigger_last_time" IS '上次触发的时间戳';
COMMENT ON COLUMN "public"."emergency_plan"."trigger_next_time" IS '下次触发的时间戳';
COMMENT ON COLUMN "public"."emergency_plan"."update_time" IS '更新时间';
COMMENT ON COLUMN "public"."emergency_plan"."update_user" IS '更新人';
...
-- ----------------------------
ALTER TABLE "public"."emergency_plan" ADD CONSTRAINT "emergency_plan_pkey" PRIMARY KEY ("plan_id");
