...
package com.huawei.common.ngrinder.service;
 ...
 * @since 2022-01-17
 **/
@FeignClient(url = "${decisionEngine.url}" + "/rest/script", name = "script", configuration = FeignConfiguration.class)
public interface NgrinderScriptService {
    /**
     * 新建脚本
     *
     * @param path                  路径
    ...
    JSONObject createScript(@RequestParam(required = false) String path,
    ...
    String saveScript(@RequestBody Map<String, String> jsonObject,
                      ...
                      @RequestParam(defaultValue = "false") String createLibAndResource);
